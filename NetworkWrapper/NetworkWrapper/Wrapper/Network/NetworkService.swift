...
public final class DefaultNetworkService {
    ...
    private func request(request: URLRequest, shouldDecrpto: Bool, completion: @escaping CompletionHandler) -> NetworkCancellable {
...
extension DefaultNetworkService: NetworkService {
    ...
    public func request(endpoint: Requestable, completion: @escaping CompletionHandler) -> NetworkCancellable? {
        do {
            ...
            return request(request: urlRequest, shouldDecrpto: endpoint.isSecurity, completion: completion)
        } catch {
